...
Full agent instructions: **[SKILL.md](https://github.com/augmentableai/skills/blob/main/skills/tpsreport-knowledge-base-generation/SKILL.md)**
...
Copy **[KB_AGENT_PROMPT.md](https://github.com/augmentableai/skills/blob/main/skills/tpsreport-knowledge-base-generation/references/KB_AGENT_PROMPT.md)**, fill in `[TOPIC]`, `[Folder_Name]`, and paste into Cursor / Claude Code.
