...
Full contract: [metadata-contract.yaml](https://github.com/augmentableai/skills/blob/main/skills/tpsreport-knowledge-base-generation/references/metadata-contract.yaml)
